  ...
  return (
    <View style={styles.container}>
      <Image 
        ...
        style={[styles.mainBackgroundImage, { opacity: backgroundVisible ? (0.6 as const) : (0.3 as const) }]}
      />
      <FlowerBackground />
      <TermsModal />
      <Pressable 
