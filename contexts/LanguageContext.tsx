...
const translations = {
  en: {
    ...
    copyrightProtectionText: 'This application and all its contents, including but not limited to design, code, graphics, text, and functionality, are protected by copyright law and owned by robotiyee@gmail.com.',
    ...
    intellectualPropertyText: 'All intellectual property rights in this application remain with robotiyee@gmail.com. No rights are granted to users except for personal, non-commercial use as outlined in these terms.',
    ...
    contactText: 'For permissions, licensing inquiries, or questions about these terms, contact: robotiyee@gmail.com',
    ...
    ultimateFeature2: 'Custom Style Analysis',
    ultimateFeature3: 'Advanced AI Analysis',
    ultimateFeature4: 'Priority support',
    ultimateFeature5: 'Style trend insights',
    ultimateFeature6: 'Email support',
    ultimateFeature7: 'Export analysis results',
    ultimateFeature8: 'Exclusive color palette recommendations',
    ultimateFeature9: 'Early access to new features',
    ultimateFeature10: 'VIP community & style challenges',
  ...
  tr: {
    ...
    copyrightProtectionText: 'Bu uygulama ve tasarım, kod, grafikler, metin ve işlevsellik dahil ancak bunlarla sınırlı olmamak üzere tüm içerikleri telif hakkı yasaları ile korunmaktadır ve robotiyee@gmail.com’a aittir.',
    ...
    intellectualPropertyText: 'Bu uygulamadaki tüm fikri mülkiyet hakları robotiyee@gmail.com’a aittir. Bu şartlarda belirtilen kişisel, ticari olmayan kullanım dışında kullanıcıya hak tanınmaz.',
    ...
    contactText: 'İzinler, lisans talepleri veya bu şartlarla ilgili sorular için: robotiyee@gmail.com',
    ...
    ultimateFeature2: 'Özel Stil Analizi',
    ultimateFeature3: 'Gelişmiş AI Analizi',
    ultimateFeature4: 'Öncelikli destek',
    ultimateFeature5: 'Stil trend içgörüleri',
    ultimateFeature6: 'E-posta desteği',
    ultimateFeature7: 'Analiz sonuçlarını dışa aktar',
    ultimateFeature8: 'Özel renk paleti önerileri',
    ultimateFeature9: 'Yeni özelliklere erken erişim',
    ultimateFeature10: 'VIP topluluk ve stil yarışmaları',
